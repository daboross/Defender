...
public class GLImage {
     ...
     *
     * @param imageFileContents byte array containing the guts of a JPG, GIF, or
     * PNG
     */
    public static BufferedImage makeBufferedImage(byte[] imageFileContents) {
     ...
     * @param imgName
     */
    public final boolean makeGLImage(BufferedImage tmpi, boolean flipYaxis, boolean convertToPow2) {
        if (tmpi != null) {
            if (flipYaxis) {
                tmpi = flipY(tmpi);
            }

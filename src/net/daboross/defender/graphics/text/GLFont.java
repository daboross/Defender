...
public class GLFont {
     ...
     * @param bgColor background color as rgb or rgba values in range 0-1 (set
     * alpha to 0 to make transparent)
     */
     ...
     * @see print()
     */
    public final void makeFont(Font f, float[] fgColor, float[] bgColor) {
        int charsetTexture;
     ...
     *
     * @param charSetImage texture image containing 100 characters in a 10x10
     * grid
